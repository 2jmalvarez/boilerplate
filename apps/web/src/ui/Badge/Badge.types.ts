...
export interface BadgeProps extends VariantProps<typeof badgeVariants> { /** Badge text or inline content. */ children: ReactNode; /** Optional composition class. */ className?: string; }
